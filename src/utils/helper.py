...
def train_loop(x_train_flat,y_train,x_test_flat,y_test,max_iter:int,model:Network,batch_size:int=None,beta=0.0,loss_fn=CrossEntropy,eta=0.01,print_iter=10,lmda=0.0,grad_algo=None)->None:
